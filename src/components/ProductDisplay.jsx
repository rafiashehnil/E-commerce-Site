    ...
    <section>
      <div className="flex flex-col gap-14 xl:flex-row px-4 lg:px-8">
        ...
        <div className="flex flex-col">
          <h3 className="text-2xl sm:text-3xl lg:text-2xl xl:text-4xl font-semibold">
            {product.name}
          </h3>
          ...
          <div className="mb-4">
            ...
            <div className="flex gap-3 my-3">
              <div className="ring-2 ring-slate-900 h-10 w-10 flex items-center justify-center cursor-pointer">
                S
              </div>
              <div className="ring-2 ring-slate-900/10 h-10 w-10 flex items-center justify-center cursor-pointer">
                M
              </div>
              <div className="ring-2 ring-slate-900/10 h-10 w-10 flex items-center justify-center cursor-pointer">
                L
            ...
            <div className="flex flex-col gap-y-3 mb-4 max-w-[555px]">
              <button onClick={()=>
               ...
               className="bg-transparent border-2 border-gray-900 text-gray-900 py-2 px-4 rounded-none uppercase text-sm tracking-widest hover:bg-gray-900 hover:text-white transition duration-300">
                Add to cart
              </button>
            ...
            <p className="text-gray-700">
              ...
              Women | Salwar Kamiz | Summer
            </p>
            <p className="text-gray-700">
              <span className="text-sm sm:text-base font-bold">Tags:</span>{" "}
              Ethnic | Modern | Stylish
            </p>
          </div>
        </div>
      </div>
