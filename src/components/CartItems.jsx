   ...
   <section className="max_padd-container pt-28">
    ...
    <div className="flex flex-col gap-20 my-16 p-8 md:flex-row rounded-md bg-white w-full max-w-[666px]">
        <div className="flex flex-col gap-10">
            ...
            <div>
                <div className="flexBetween py-4">
                    ...
                    <h4 className="text-gray-30 font semi-bold">Tk{0}</h4>
            ...
            <div className="flexBetween py-4">
                ...
                <h4 className="text-gray-30 font semi-bold">Free</h4>
            </div>
            <hr/>
            <div className="flexBetween py-4">
                <h4 className="bold-18">Total:</h4>
                <h4 className="bold-18">Tk{0}</h4>
        ...
        <div className='flex flex-col gap-10'>
            ...
            <div className="flexBetween pl-5 h-12 bg-white rounded-full ring-1 ring-slate-900/10 ">
